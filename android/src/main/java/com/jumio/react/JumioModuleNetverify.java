...
public class JumioModuleNetverify extends JumioBaseModule {
        ...
        public void onActivityResult(Activity activity, int requestCode, int resultCode, Intent data) {
            ...
            if (requestCode == NetverifySDK.REQUEST_CODE) {
                ...
                if (resultCode == Activity.RESULT_OK) {
                    ...
                    String accountId = data.getStringExtra(NetverifySDK.EXTRA_ACCOUNT_ID);
                    Boolean authenticationResult = data.getExtras().getBoolean(NetverifySDK.EXTRA_AUTHENTICATION_RESULT);
                    ...
                    if (authenticationResult != null) {
                        result.putBoolean("authenticationResult", authenticationResult);
                    }
    ...
    @ReactMethod
    public void initSingleSessionNetverify(String authorizationToken, String dataCenter, ReadableMap options) {
        try {
            ...
            netverifySDK = NetverifySDK.create(getCurrentActivity(), authorizationToken, center);
