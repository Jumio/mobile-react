...
@interface RCT_EXTERN_MODULE(JumioMobileSDK, RCTEventEmitter)
    RCT_EXTERN_METHOD(initialize:(NSString *)token dataCenter:(NSString *)dataCenter resolver:(RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject)
    ...
    RCT_EXTERN_METHOD(checkCachedResult)
@end
