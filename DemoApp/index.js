...
// Single Session Netverify

const startSingleSessionNetverify = (authorizationToken) => {
    JumioMobileSDKNetverify.initSingleSessionNetverify(authorizationToken, DATACENTER, {
        enableVerification: true,
        //callbackUrl: "URL",
        //enableIdentityVerification: true,
        //preselectedCountry: "USA",
...
const AuthTokenInput = () => {
    ...
    return (
        <View>
            ...
            />
            <Button
                onPress={() => startSingleSessionNetverify(authorizationToken)}
                style={styles.buttonStyle}>
                Start Single Session Netverify
            </Button>
        </View>
    );
};
